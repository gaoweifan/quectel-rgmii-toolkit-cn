...
```bash
adb shell "cd /tmp && wget -O RMxxx_rgmii_toolkit.sh https://gh-proxy.com/https://raw.githubusercontent.com/gaoweifan/quectel-rgmii-toolkit-cn/SDXLEMUR/RMxxx_rgmii_toolkit.sh && chmod +x RMxxx_rgmii_toolkit.sh && ./RMxxx_rgmii_toolkit.sh" && cd /
```
...
Then run
```
cd /tmp && wget -O RMxxx_rgmii_toolkit.sh https://gh-proxy.com/https://raw.githubusercontent.com/gaoweifan/quectel-rgmii-toolkit-cn/SDXLEMUR/RMxxx_rgmii_toolkit.sh && chmod +x RMxxx_rgmii_toolkit.sh && ./RMxxx_rgmii_toolkit.sh && cd /
```
**You should see:**
