...
toolkit_menu() {
    while true; do
        ...
        case "$option" in
            1) cd /tmp && wget -O RMxxx_rgmii_toolkit.sh https://gh-proxy.com/https://raw.githubusercontent.com/gaoweifan/quectel-rgmii-toolkit-cn/SDXLEMUR/RMxxx_rgmii_toolkit.sh && chmod +x RMxxx_rgmii_toolkit.sh && ./RMxxx_rgmii_toolkit.sh && cd / ;;
            2) cd /tmp && wget -O RMxxx_rgmii_toolkit.sh https://gh-proxy.com/https://raw.githubusercontent.com/gaoweifan/quectel-rgmii-toolkit-cn/dev-SDXLEMUR-cn/RMxxx_rgmii_toolkit.sh && chmod +x RMxxx_rgmii_toolkit.sh && ./RMxxx_rgmii_toolkit.sh && cd / ;;
            3) break ;;
